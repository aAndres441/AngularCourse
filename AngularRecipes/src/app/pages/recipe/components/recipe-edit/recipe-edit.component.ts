...
export class RecipeEditComponent implements OnInit { // , OnDestroy
 ...
 /* esto puedo borrrars solo emntrevera
  ...
  submitEditOk = false;
  nameEditDEfault: number;
  @ViewChild('nameEdit', { static: false }) nameValorIngresado: ElementRef;
  // tslint:disable-next-line: max-line-length
  descriptionEditDefault = 'Juan , <span class=class=help class=help-blo cngIf !nameEdi t.valid && nameEdit.touched- blocngIf !nameEdit.valid && nameEdit.touchedhel p-blocngIf !nameEdit.valid && nameEdit.touched ';
  idEditDefault = 2500; /* +this.id */
